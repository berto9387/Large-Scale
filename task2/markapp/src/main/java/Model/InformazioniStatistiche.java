 ...
 * @author tony_
 */
public class InformazioniStatistiche {
    ...
    public InformazioniStatistiche() {
    ...
    public InformazioniStatistiche(Statistica statistica, String ruolo){
    ...
    public InformazioniStatistiche(StringProperty stagione, StringProperty competizione, StringProperty squadra, StringProperty presenze, StringProperty puntiPartita, StringProperty goal, StringProperty assist, StringProperty ammonizioni, StringProperty doppieAmmonizioni, StringProperty espulsioni, StringProperty minutiGiocati, StringProperty retiSubite, StringProperty partiteNoGoal) {
