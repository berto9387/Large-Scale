...
public class InformazioniRicercaCalciatore {
    ...
    public InformazioniRicercaCalciatore(StringProperty idCalciatore, StringProperty nome, StringProperty ruoloPrincipale, StringProperty squadra, StringProperty eta,  
